	...
	return (
		<section>
			<div className="px-6 py-24 md:flex items-center justify-center gap-x-4 md:px-10 lg:px-40">
				<div className="w-full pt-20 pb-4 mb-14 relative bg-paleWhite rounded-lg shadow-md md:mb-0">
					<img
					...
					<Link
						to={"/headphones"}
						className="w-full flex items-center gap-x-4 justify-center">
						<span className="uppercase tracking-wide text-black/50">shop</span>
						<img
				...
				<div className="w-full pt-20 pb-4 relative bg-paleWhite rounded-lg shadow-md">
					<img
